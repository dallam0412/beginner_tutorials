...
#ifndef CPP_PUBSUB__SRV__DETAIL__STRINGS__FUNCTIONS_H_
#define CPP_PUBSUB__SRV__DETAIL__STRINGS__FUNCTIONS_H_
...
/// Initialize srv/Strings message.
/**
...
/// Create srv/Strings message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * cpp_pubsub__srv__Strings_Request__init().
...
/// Destroy srv/Strings message.
/**
 * It calls
 * cpp_pubsub__srv__Strings_Request__fini()
...
/// Check for srv/Strings message equality.
/**
...
/// Initialize array of srv/Strings messages.
/**
...
/// Finalize array of srv/Strings messages.
/**
 * It calls
 * cpp_pubsub__srv__Strings_Request__fini()
...
/// Create array of srv/Strings messages.
/**
 * It allocates the memory for the array and calls
 * cpp_pubsub__srv__Strings_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Strings messages.
/**
 * It calls
 * cpp_pubsub__srv__Strings_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Strings message array equality.
/**
...
/// Copy an array of srv/Strings messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * cpp_pubsub__srv__Strings_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cpp_pubsub
...
/**
 * It calls
 * cpp_pubsub__srv__Strings_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_cpp_pubsub
...
/**
 * It allocates the memory for the array and calls
 * cpp_pubsub__srv__Strings_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cpp_pubsub
...
/**
 * It calls
 * cpp_pubsub__srv__Strings_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CPP_PUBSUB__SRV__DETAIL__STRINGS__FUNCTIONS_H_
